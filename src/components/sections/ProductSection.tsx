          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div className="animate-fade-in order-2 md:order-1 flex justify-center">
              <div className="relative w-full max-w-sm md:max-w-none">
                {/* Glow Effect */}
                <div className="absolute inset-0 bg-gradient-to-br from-accent/20 to-tech-glow/20 blur-2xl md:blur-3xl rounded-full" />
                
                {/* Video Container */}
                <div className="relative glass-card p-0 rounded-2xl md:rounded-3xl shadow-2xl flex justify-center items-center mx-auto">
                  <div className="aspect-[9/16] bg-gradient-to-br from-primary to-background-alt rounded-xl md:rounded-2xl border-0 overflow-hidden mx-auto w-full">
                    <iframe
            ...
            {/* Content */}
            <div className="animate-fade-in space-y-4 md:space-y-6 order-1 md:order-2" style={{ animationDelay: '0.2s' }}>
              ...
              <div className="space-y-3 md:space-y-4 text-base md:text-lg text-foreground-secondary leading-relaxed">
                <p>
                ...
                <p>
                  Por isso criei o <span className="text-accent font-bold text-lg md:text-xl whitespace-nowrap">Fator Essencial</span>:
                </p>
